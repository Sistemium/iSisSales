//
//  STMVisitQuestionGroup+CoreDataProperties.h
//  iSisSales
//
...
@interface STMVisitQuestionGroup (CoreDataProperties)
...
@property (nullable, nonatomic, retain) STMVisitQuestionSet *visitQuestionSet;

@end

@interface STMVisitQuestionGroup (CoreDataGeneratedAccessors)
